...
Private backend for the Botswana ISP Tracker (public site: bwispqosd, live at
edmundondo.github.io/bwispqosd).

This is the same admin app as [zwispqosp](https://github.com/edmundondo/zwispqosp),
pointed at the `bw` site by default — one shared Supabase project serves Zimbabwe,
...
breakdown, RLS policy notes and backend setup steps; none of that is Botswana-specific.
Actual Supabase credentials live only in the Supabase dashboard — never in this repo.
